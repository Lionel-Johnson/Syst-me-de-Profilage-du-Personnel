                            ...
                            <div class="modal-body"></div>
                                ...
                                <body>
                                    <div class="ui-widget">
                                        ...
                                        Preparé par: <input ng-model="firstname">
                                        Certifié Correct: <input ng-model="Certified">

                                    </div>
                                    <div class="modal-footer">
                                        <button onclick="printContent('print')" id = "hit" style="float: right;">Rapport d'impression</button>  
                                    </div>
                                </body>
                            </head>
                        </form>
