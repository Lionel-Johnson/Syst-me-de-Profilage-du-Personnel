...
<center>
    <div class="backk" style="float: left; margin-left: 120px;">
        <button><a href="gass_profile_by_campus.php">Retour</a></button>
    </div>
        ...
        <br />
            ...
            <table id = "example" class = "stripe order-table" cellspacing = "0" style="margin: 10px;">
               <thead>
                    <tr>
                        <th >Etablissement</th>
                        <th >Nombre de personnel en FONCTION</th>
                    </tr>
                </thead>
                    <tbody>
                                <?php
                                    $afilter = $con->prepare("SELECT atotal1.atotal2 + atotal3.atotal4 as atotal FROM (
                                        ...
                                        FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Ecole Normale Supérieure' AND per_designation in ('GASS' , 'Job Order') 
                                        ) as atotal1,
                                        (
                                        SELECT COUNT(*) as atotal4
                                        FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Ecole Normale Supérieure'AND per_designation in ('GASS' , 'Job Order')
                                        ) as atotal3 ");
                                        $afilter->execute();
                                    ...
                                    $tfilter = $con->prepare("SELECT ttotal1.ttotal2 + ttotal3.ttotal4 as ttotal FROM (
                                        ...
                                        FROM   tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'UOB' AND per_designation in ('GASS' , 'Job Order') 
                                        ) as ttotal1,
                                        (
                                        SELECT COUNT(*) as ttotal4
                                        FROM   tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'UOB' AND per_designation in ('GASS' , 'Job Order')
                                        ) as ttotal3 ");
                                    $tfilter->execute();
                                    ...
                                    $bfilter = $con->prepare("SELECT btotal1.btotal2 + btotal3.btotal4 as btotal FROM (
                                        ...
                                        FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation in ('GASS' , 'Job Order') 
                                        ) as btotal1,
                                        (
                                        SELECT COUNT(*) as btotal4
                                        FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation in ('GASS' , 'Job Order')
                                        ) as btotal3 ");
                                        ...
                                        FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'USTM' AND per_designation in ('GASS' , 'Job Order') 
                                        ) as fttotal1,
                                        (
                                        SELECT COUNT(*) as fttotal4
                                        FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'USTM' AND per_designation in ('GASS' , 'Job Order')
                                        ) as fttotal3 ");
                                ...
                                <?php
                                include('connect.php');
                                 $display = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'UOB' AND per_designation in ('GASS' , 'Job Order')");
                                    $display->execute();
                                ...
                                <?php
                                 ...
                                 $display1 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Ecole Normale Supérieure' AND per_designation in ('GASS' , 'Job Order')");
                                    $display1->execute();
                                ...
                                <?php
                                 ...
                                 $display2 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'USTM' AND per_designation in ('GASS' , 'Job Order')");
                                    $display2->execute();
                                ...
                                <?php
                                 ...
                                 $display3 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation in ('GASS' , 'Job Order')");
                                    $display3->execute();
