            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <td colspan="5" style="border:0px; margin-left: 100%;">
                                <center>PROFILE DE FACULTE</center>
                            </td>
                        </tr>
                        <tr>
                            <th>Programme</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>INSTITUT DU PETROLE ET DU GAZ</td>
                            <td>
                                <?php echo $total10; ?>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>LYCEE TECHNIQUE JEAN FIDELE OTANDO</td>
                            <td>
                                <?php echo $total16; ?>
                            </td>
                            <td>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default close-modal" data-dismiss="modal">Fermer
                    </button>
                    <button onclick="myFunction()" class="btn btn-primary">Imprimer le reçu</button>
                </div>
            </div>
            </form>
        </div>
