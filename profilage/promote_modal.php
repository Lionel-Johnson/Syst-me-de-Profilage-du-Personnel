<a class="btn btn-success" href="#edit<?php echo $row['per_id']?>" data-toggle="modal">
    <span class="glyphicon glyphicon-edit">mettre à jour</span>
</a> 
<?php
include ("connect.php");
			...
			<div class="input-group">
				<span class="input-group-addon">
					...
					<option><?php echo $row['per_designation']; ?></option>
						...
						<option>JOrdre de Travail</option>
					</select>
			</div>
        </div>
        <div class="modal-footer">
            <button type="submit" class="btn btn-success btn-lg" name = "update">Mettre à Jour</button>
        </div>
            </form>
        </div>
        </div>
