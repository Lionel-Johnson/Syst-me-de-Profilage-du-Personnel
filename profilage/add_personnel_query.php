...
if(isset($_POST['save'])) {
	...
	$add_personnel = $con->prepare("INSERT INTO tbl_personnel (per_firstname,  per_lastname,per_suffix, per_gender, per_status, per_address, pos_id, rank_id, dept_id,per_designation, per_date_of_birth, per_place_of_birth,per_date_of_original_appointment,per_eligibility, per_tin_no, per_gsis_bp_no, per_pagibig_no, per_contact_no, per_plantilla_no, per_campus ,bs_name, bs_year, bs_school, ms_name, ms_with_unit, ms_year, ms_school, dr_name, dr_with_unit, dr_year, dr_school, other_degree, other_year, other_school, date_modified , gass_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ? )");
	$add_personnel->execute(array($per_firstname,  $per_lastname, $per_gender,$per_status,$per_address, $per_position, $per_rank, $dept_id, $per_designation, $per_date_of_birth, $per_place_of_birth,$per_date_of_original_appointment,$per_eligibility, $per_tin_no, $per_gsis_bp_no, $per_pagibig_no, $per_contact_no, $per_plantilla_no, $per_campus,$bs_name, $bs_year, $bs_school, $ms_name, $ms_with_unit, $ms_year, $ms_school, $dr_name, $dr_with_unit, $dr_year, $dr_school, $other_degree, $other_year, $other_school,$gass_id));
