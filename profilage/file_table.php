                ...
                <div class="">
                    <div class = "panel panel-primary">
                        <div class = "panel-heading">
                            <button class = "btn btn-default" href="#" data-toggle="modal" data-target="#add_file" style = "float:right; width:150px;">Ajouter un fichier</button>
                            <h4>FICHIERS DU PERSONNEL</h4>
                        </div>
                    </div>
