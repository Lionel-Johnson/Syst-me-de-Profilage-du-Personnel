...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="fortune_towne_campus.php">Retour</a></button>
  </div>
    ...
    <div class="prepared-form" style="border: 1px solid; width: 30%; margin-right: 300px;">
      ...
      <table>
        ...
        <tr>
          ...
          <td><input ng-model="certifié" placeholder="Name" class="form-control" required=""></td>
        </tr>
        <tr>
          <td>Position :</td>
    ...
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <table id = "example" class = "stripe order-table" cellspacing = "0" >
                                ...
                                <tr>
                                  <?php
                                    include('connect.php');
                                    $display = $con->prepare("SELECT * FROM tbl_personnel LEFT JOIN tbl_position ON tbl_personnel.pos_id=tbl_position.pos_id WHERE per_campus = 'Institut National des Science de l'Orgqnisation' ORDER BY per_id ASC");
                                    $display->execute();
