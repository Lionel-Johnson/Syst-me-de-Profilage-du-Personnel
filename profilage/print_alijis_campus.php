...
<center>
  <div class="backk" style="float: left; margin-left: 120px;">
    <button><a href="Ecole Normale Supérieure_campus.php">Retour</a></button>
  </div>
  ...
  <div ng-app="myApp" ng-controller="myCtrl">
    <div class="prepared-form" style="border: 1px solid; width: 30%; margin-right: 300px;">
      <i>Note: Merci de remplir ce formulaire s'il vous plaît.</i>
      <br><br>
      <table>
        <tr>
          <td>Preparé par :</td>
          <td><input ng-model="firstname" placeholder=" n om" class="form-control" required=""></td>
        </tr>
        <tr>
          <td>Position :</td>
        ...
        <tr>
          ...
          <td><input ng-model="certified" placeholder="Nom" class="form-control" required=""></td>
        </tr>
        <tr>
          <td>Position :</td>
  ...
  <div id="print" style="border: 1px solid; width: auto; height: auto;">
    <div class="report-title" style = "margin:10px;"><br/>
      ...
      <center>Republique Gabonaise</center>
