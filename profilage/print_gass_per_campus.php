...
<center>
    <div class="backk" style="float: left; margin-left: 120px;">
        <button><a href="FONCTION_per_campus.php">Retour</a></button>
    </div>
        ...
        <br />
            ...
            <table id = "example" class = "stripe order-table" cellspacing = "0" style="margin: 10px;">
               <thead>
                                    <tr>
                                        <th > Etablissement</th>
                                        <th >Nombre du personnel en Fonction</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                    ...
                                    $bfilter = $con->prepare("SELECT btotal1.btotal2 + btotal3.btotal4 as btotal FROM (
                                        ...
                                        FROM tbl_personnel WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation = 'FONCTION'
                                        ) as btotal1,
                                        (
                                        SELECT COUNT(*) as btotal4
                                        FROM tbl_personnel_master_file WHERE date_modified >= '$d1' AND date_modified <= '$d2' AND per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation = 'FONCTION'
                                        ) as btotal3 ");
                                ...
                                <thead>
                                    <tr>
                                        <td>ETABLISSEMENT</td>
                                        <td>Numéro matricule du Personnel</td>
                                    </tr>
                                </thead>
                                <tbody>
                                <tr>
                                ...
                                <?php
                                 ...
                                 $display3 = $con->prepare("SELECT COUNT(*) FROM tbl_personnel where per_campus = 'Institut National des Sciences de l'Organisation' AND per_designation = 'FONCTION' ");
                                    $display3->execute();
...
//    css_html = css_html.replace(/ /g, '%20');
    ...
    a.download = 'Summary of FONCTION Profile by Campus_' + postfix + '.xls';
