                    ...
                    <div class="card">
                        <div class = "panel panel-primary">
                            <div class = "panel-heading">
                                <h4>PROFILES DES FACULTES PAR FONCTION ACCADEMIQUE</h4>
                        ...
                        <div id="print">
                            ...
                            ?>
                             <table id = "example" class = "stripe" cellspacing = "0" >
                                <thead>
                                    <tr>
                                        <th >Rang Accadémique</th>
                                        <th >Université Omar Bongo</th>
                                        <th >Ecole Nornale Supérieure</th>
                            ...
                            <?php } else { ?>
                                ...
                                <tbody>
                                     <?php
                                            ...
                                            $tbs = $con->prepare("SELECT COUNT(*) FROM tbl_personnel WHERE per_campus = 'Université Omar Bongo' AND rank_id = '$rank_id' ");
                                                $tbs->execute();
                                                $ftbs = $tbs->fetchAll();
                                            ...
                                            $abs = $con->prepare("SELECT COUNT(*) FROM tbl_personnel WHERE per_campus = 'Ecole Nornale Supérieure' AND rank_id = '$rank_id' ");
                                                $abs->execute();
                                                $fabs = $abs->fetchAll();
                                            ...
                                            //TOTAL
                                            $tbss = $con->prepare("SELECT COUNT(rank_id) FROM tbl_personnel WHERE per_campus = 'Université Omar Bongo' AND rank_id<>0 ");
                                                $tbss->execute();
                                                $ftbss = $tbss->fetchAll();
                                            ...
                                            $fttbss = $con->prepare("SELECT COUNT(rank_id) FROM tbl_personnel WHERE per_campus = 'Ecole Nornale Supérieure' AND rank_id<>0 ");
                                                $fttbss->execute();
                                                $fftbss = $fttbss->fetchAll();
